...
const nav = `
  <header class="site-header">
    ...
    <span class="header-note">Архив движущихся образов</span>
  </header>`;

function layout(content, route = 'home') {
  document.querySelector('#app').innerHTML = `${nav}<main>${content}</main><footer><span>КИНОСФЕРА / 001</span><span>История кино — это история взгляда</span></footer>`;
